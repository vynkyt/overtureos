...
var MealTracker = (function () {
    ...
    var FOODS = [
        ...
        { name: "Yogi Chocolate Sticks", img: "img/food/yogichocosticks.png", cal: 180, cat: "snacks" },
        { name: "Unagi Roll (1 pcs)", img: "img/food/unagiroll.png", cal: 50, cat: "snacks" },
        { name: "Egg Waffle (1 bubble)", img: "img/food/eggwaffle.png", cal: 10, cat: "snacks" },
        { name: "Red Bean Mochi (1pcs)", img: "img/food/rbmochi.png", cal: 100, cat: "snacks" },
    ...
    var INGREDIENTS = [
        ...
        { name: "Luncheon Meat (~2mm)", cal: 70, cat: "protein" },
        { name: "Luncheon Meat (~5mm)", cal: 100, cat: "protein" },
        { name: "Honey Chicken (1pcs)", cal: 90, cat: "protein" },
        { name: "Minced Pork (100g)", cal: 260, cat: "protein" },
        ...
        { name: "Cabbage (1 cup steamed)", cal: 30, cat: "vegetable" },
        ...
        { name: "Mushroom (100g)", cal: 30, cat: "vegetable" },
        ...
        { name: "Hot Sauce (1 tbsp)", cal: 5, cat: "condiment" },
        { name: "Teriyaki Sauce (1 tbsp)", cal: 30, cat: "condiment" },
